...
function LinkedInMark(props: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      {/* white plate behind the glyph: the "in" letterforms are cut-outs in
          the path below, so they read as white on the brand blue in both themes */}
      <rect x="1" y="1" width="22" height="22" rx="1.2" fill="#ffffff" />
      <path
        fill="#0A66C2"
      ...
      <div className="mx-auto max-w-content">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-between gap-x-8 gap-y-4 border-t border-line pt-6">
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2 font-mono text-xs uppercase tracking-[0.14em]">
            ...
            >
              <LinkedInMark className="h-[1.15rem] w-[1.15rem]" />
            </a>
            <a
              href={profile.github}
              target="_blank"
